            ...
            Rectangle {
                ...
                Column {
                    ...
                    TextField {
                        ...
                        placeholderText: i18n.tr("Meal description")
                    ...
                    Label {
                        height: units.gu(2)
                        text: i18n.tr("Calories: ") + Math.round(caloriesInput.value)
                        font.bold: true
                    }
